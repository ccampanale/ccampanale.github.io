...
<div id="leftPan">
	...
	<div id="updatesPan">
		<ul>
			<li class="push">&nbsp;</li>
			<li> <img src="images/updates_icon.jpg" alt="" width="109" height="105" align="top" /><a href="http://www.steampowered.com" target="_blank">view story</a></li>	
		</ul>
	</div>
  </div>
  <!--leftPan close -->
  ...
  <div id="rightPan">
    <p class="toppush">
	<span class="bigsize">&ldquo;</span>Finally up and somewhat running. Large portions of this site are still under complete construction and others will always be....<span class="bigsize">&quot;</span>	    
